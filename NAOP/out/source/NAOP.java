/* autogenerated by Processing revision 1286 on 2023-02-25 */
...
private class MovingAverage {
 ...
 if (keyCode == ALT){ // .. in Keypressed
  ...
  if ((key == '!'  ) ) {  
    ...
    String dataMarkedToDue  ="<" 
      + mapAcceleration[11]+","+ PApplet.parseInt  (bpmToSend)  +","+cohesionCounterHigh+","+ onOFF+","+nextScene+","
      ...
      +PApplet.parseInt (phazi[11])+","+PApplet.parseInt (phazi[0])+","+PApplet.parseInt (phazi[11])+","+PApplet.parseInt (phazi[0])+","+PApplet.parseInt (phazi[11])+","
...
*/
 ...
 public void addSignalOneAndTwoTer(){
    print (formerKeyMetro);
...
//   int splitTimeLfo = millis()%150; // linear time  to change " oscillator " each 200 ms
 ...
 public void addSignalOneAndTwoQuater() {
 //   signal2 continue
 //   signal to split sinus
  // lfoPattern(); // if ive is not open  //lfoPattern(); // if Live is not open
    // if you dob't use this, uncomment signal2 in addSignalLfoPattern()
...
// splitTimeQuater(30.0);
 ...
 formerKey=key;
  ...
  public void addSignalLfoPatternQuater()  { //|| doZ==false
...
//  if  (   formerKeyMetro != 'c') {  // VERY IMPORTANT with CASE c
 ...
 public void send24DatasToTeensy6motors(int accelerationRatio, int driver0_On_Off, int computeData){  // dataMarkedToTeensyArevoir
