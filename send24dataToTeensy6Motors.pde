void send24DatasToTeensy6motors(int accelerationRatio, int driver0_On_Off, int computeData){  // dataMarkedToTeensyArevoir
      ...
      +  accelerationRatio +","+ driver0_On_Off +","+ computeData +","
